...
@section('content')
    <div class="col-12 my-4">
        ...
        <form action="{{ route('eligibility.calculate.store') }}" method="POST" class="bg-light p-5 contact-form">
            @if ($errors->any())
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="dateInput" name="headline_date" value="{{ old('headline_date') }}">
            </div>

            <div class="form-group">
                <button type="submit" class="btn btn-primary py-2 px-5">Tambahkan</button>
            </div>
        </form>
    </div>
@endsection
