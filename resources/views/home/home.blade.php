            ...
            @foreach ($posts as $item)
                <div class="col-md-12">
                    <div class="blog-entry ftco-animate d-md-flex">
                        <a href="{{ route('postShow', $item->id) }}" class="img img-2"
                            style="background-image: url({{ asset('storage/' . $item->thumbnail) }});"></a>
                        <div class="text text-2 pl-md-4">
                            ...
                            <div class="tagcloud">
                                <a href="{{ route('search', ['category' => $item->category->id]) }}"
                                    class="tag-cloud-link">{{ $item->category->name }}</a>
                            </div>
                            <p class="mb-4">
                            ...
                            <p>
                                <a href="{{ route('postShow', $item->id) }}" class="btn-custom">Baca selengkapnya <span
